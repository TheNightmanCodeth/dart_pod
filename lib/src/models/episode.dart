...
/// Holds data for a podcast episode. *Just* a helper class.
class Episode {
  var title, description, pubDate, url;
  Episode(var this.title, var this.description, var this.pubDate, var this.url);
}
